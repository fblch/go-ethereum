...
func (ethash *Ethash) Finalize(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, dummy bool) error {
...
func (ethash *Ethash) FinalizeAndAssemble(chain consensus.ChainHeaderReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt, dummy bool) (*types.Block, error) {
	// Finalize block
	// MODIFIED by Jakub Pajek (clique static block rewards)
	//ethash.Finalize(chain, header, state, txs, uncles)
	ethash.Finalize(chain, header, state, txs, uncles, dummy)
