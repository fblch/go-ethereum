...
// MEMO by Jakub Pajek (x/mobile: Calling net.Interfaces() fails on Android SDK 30+)
// This function is heavily used inside the goupnp/dcps autogenerated code but seems to be unused by geth.
// Instead of addind the localIPv4MCastAddr parameter and having to modify all the goupnp/dcps code
// we leave the function signature as is and pass nil to DiscoverDevices call, hoping that mobile works fine.
// func NewServiceClients(localIPv4MCastAddr net.IP, searchTarget string) (clients []ServiceClient, errors []error, err error) {
func NewServiceClients(searchTarget string) (clients []ServiceClient, errors []error, err error) {
	...
	if maybeRootDevices, err = DiscoverDevices(nil, searchTarget); err != nil {
		return
	}
