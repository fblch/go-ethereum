// el_stack_net.go contains hand-written helpers that adapt the
// uniffi-generated el_stack bindings to Go's standard net.Conn /
// net.Listener / net.PacketConn interfaces.
//
// This file is NOT regenerated by uniffi-bindgen-go and must be kept
// in this package alongside el_stack.go. When el_stack.go is
// regenerated (see generate_go.sh), this file is preserved.
...
// ======================= Stream RecvSafe =======================
//
// uniffi-bindgen-go が生成する Recv は panic で異常終了することがあるため、
// panic を捕捉して error として返すラッパーを提供します。
// 受信データ長が 0 の場合は io.EOF にマップします。
...
// RecvSafe は内部 panic をキャッチして error で返すラッパーです
